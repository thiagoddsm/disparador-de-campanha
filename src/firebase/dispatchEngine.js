  ...
  try {
    await runTransaction(db, async (transaction) => {
      ...
      transaction.set(messageRef, {
        ...
        contact_city: cleanCity !== 'sua cidade' ? cleanCity : (contactCity || null),
        contact_neighborhood: cleanNeighborhood !== 'seu bairro' ? cleanNeighborhood : (contactNeighborhood || null),
        user_uid: userId,
        user_name: user?.name || user?.displayName || user?.email || 'Operador',
